...
function ImageTile({imageTile , like,  setDelete, fullScreen, activeButtons, favorites}) {
    ...
    <li id={imageTile.id} className={css.gallery_list}>     
          ...
          <div className={css.gallery_backdrop}>
            <div className={css.backdrop_buttons}>
                ...
                { loggedIn && <button onClick={handleSubmit} className={validActiveItem ? 'button_nav active' : 'button_nav'}><FaHeart style={{fontSize: '14px'}}/></button> }
